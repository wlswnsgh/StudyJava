...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		List<Integer> sortedList = list.stream().sorted().collect(Collectors.toList()); //체이닝 기법
		
		System.out.println(list); // 원본 데이터가 그대로 있음
		...
		Stream<Integer> stream3 = stream2.sorted(); // 값을 조작하고 새로운 스트림 생성
